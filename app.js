...
let pvr = [
  {
    ...
    date: 24,
    img: "jawan.jpg",
    video: "JawanOfficialTrailer-HDvideo9.mp4",
    background: "bg.png",
  },
  {
    pvr: "PVR Vegus",
    ...
    img: "Gadar2.jpg",
    video:
      "Gadar2OfficialTrailer-11thAugust-SunnyDeol-AmeeshaPatel-AnilSharma-ZeeStudios.mp4",
    background: "gadar_bg.jpg",
  },
  {
    pvr: "PVR Vegus",
    movie: "Jawan",
...
document.getElementById("book_ticket").addEventListener("click", () => {
  Array.from(document.getElementsByClassName("selected")).forEach((el) => {
    ...
    tic.innerHTML = `
                    ...
                    <div class="tic_details" style=" background: url(${
                      data[0].background
                    })no-repeat center -35px /cover">
